...
<head>
  ...
  <title>Portfolio - Deri kurniawan Portfolio</title>
...
<body class="theme-red">
  ...
  <div class="vg-page page-home" id="home" style="background-image: url(../assets/img/bg_image_1.jpg)">
    ...
    <div class="navbar navbar-expand-lg navbar-dark sticky" data-offset="500">
      <div class="container">
        <a href="" class="navbar-brand">Deri Kurniawan</a>
    ...
    <div class="caption-header text-center wow zoomInDown">
      <h5 class="fw-normal">Assalamualaikum wr. wb.</h5>
      <h1 class="fw-light mb-4">Saya <b class="fg-theme">Deri</b> kurniawan</h1>
      <div class="badge">Game Programmer</div>
      ...
      <div class="row">
        <div class="col-lg-4 py-6">
          <div class="img-place wow fadeInUp">
            <img src="../assets/img/deri.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          <h1 class="fw-light">Deri Kurniawan</h1>
          <h5 class="fg-theme mb-3">Game Programmer</h5>
          <p class="text-muted">Saya merupakan mahasiswa Universitas dinamika bangsa, saya  mempelajari hal hal yang berkaitan dengan IT, terutama game developer. </p>
          <ul class="theme-list">
            <li><b>Dari:</b> Merangin, Jambi, indonesia</li>
            <li><b>Tempat tinggal:</b> Merangin, Jambi, Indonesia</li>
            <li><b>Umur:</b> 20</li>
            <li><b>Jenis Kelamin:</b> Laki-Laki</li>
          </ul>
          <a href="https://drive.google.com/file/d/1RxYPO6J8U724nRV93vDJ6QgiJBATmayd/view?usp=sharing"><button class="btn btn-theme-outline">Download CV</button></a>
        </div>
      </div>
    </div>
    <div class="container py-5">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6">
          <div class="px-lg-3">
            <h4 class="wow fadeInUp">Skills lain</h4>
            <div class="progress-wrapper wow fadeInUp">
            ...
            <div class="progress-wrapper wow fadeInUp">
              <span class="caption">after efect</span>
              <div class="progress">
          ...
          <ul class="timeline mt-4 pr-md-5">
            <li>
              ...
              <div class="details">
                ...
                <small class="fg-theme">Universitas Dinamika Bangsa</small>
                <p>Mempelajari bagaimana cara menjadi seorang yang ahli dibidang IT, mempelajari langkah awal menjadi seorang developer yang baik, berguna, dan berkualitas</p>
              </div>
            </li>
            <li>
              ...
              <div class="details">
                ...
                <small class="fg-theme">SMAN 6 MERANGIN</small>
                <p>Belajar tentang dunia sains dan teknolgi. mempelajari matapelajaran inti seperti matematika, peminatan matematika, fisika, kimia, dan biologi, serta mempelajari pelajaran umum lainnya</p>
              </div>
            </li>
            <li>
              ...
              <div class="details">
                ...
                <small class="fg-theme">SMPN 43 MERANGIN</small>
                <p>Memperdalam materi yang telah diberikan di sekolah dasar, serta belajar bagaimana cara berkebun dan berkarya</p>
              </div>
            </li>
            <li>
              ...
              <div class="details">
                <h5>SEKOLAH DASAR</h5>
                <small class="fg-theme">SDN 253- VI BANGKO XII</small>
                <p>Mempelajari pelajaran umum dasar, diajarkan cara bersosialisasi, berhitung, beragama</p>
              </div>
            </li>
            <li>
              ...
              <div class="details">
                ...
                <small class="fg-theme">TK MUKTITAMA</small>
                <p>belajar bermain dan menghormati sesama teman, belajar membaca dan menulis</p>
              </div>
            </li>
          </ul>
        </div>
        <div class="col-md-6 wow fadeInRight" data-wow-delay="200ms">
          <h2 class="fw-normal">Kursus</h2>
          <ul class="timeline mt-4 pr-md-5">
            <li>
              <div class="title">2021</div>
              <div class="details">
                <h5>Studi Independent pengembangan game agate</h5>
                <small class="fg-theme">Agate Academy</small>
                <p>Mempelajari dan mendalami materi tentang game developer, mengetahui cara agar menjadi game developer dan diberi pengetahuan tentang market dan hal-hal yang berkaitan dengan game developer</p>
                <p>Link Sertifikat: klik di<a href="https://bit.ly/35h0f4V">sini</a></p>
              </div>
            </li><li>
              <div class="title">2018</div>
              <div class="details">
                <h5>Microsoft Office 2013</h5>
                <small class="fg-theme">LPK CENDANA PRIMA UTAMA KOMPUTER</small>
                <p>Mempelajari tentang microsoft office 2013 bagian word, excel, dan power point</p>
                <p>Link sertifikat :klik di<a href="https://bit.ly/3IeWtI3">sini</a></p>
              </div>
            </li>
          </ul>
        </div>
  ...
  <div class="vg-page page-service">
    <div class="container">
      ...
      <h1 class="fw-normal text-center wow fadeInUp">apa yang bisa saya lakukan?</h1>
      <div class="row mt-5">
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              <h4 class="fg-theme">Game Programming</h4>
              <p>Dapat memprogram game 2d maupun 3d sederhana berbasis android maupun desktop</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              <h4 class="fg-theme">Desktop programing</h4>
              <p>Dapat membuat software desktop sederhana menggunakan Bahasa pemograman C#</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
          <div class="card card-service wow fadeInUp">
            ...
            <div class="caption">
              ...
              <p>dapat mengembangkan web sederhana menggunakan html+css</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="gridder my-3">
        <div class="grid-item apps wow zoomIn">
          <div class="img-place" data-src="https://img.itch.zone/aW1nLzczNzA2NzEucG5n/original/7M5jUo.png" data-fancybox data-caption="<h5 class='fg-theme'>Crib in School</h5> <p>Puzzle, strategy <p> <a href='https://flycatgames.itch.io/crib-in-school'>Download game</a></p></p>">
            <img src="https://img.itch.zone/aW1nLzczNzA2NzEucG5n/original/7M5jUo.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Crib in School</h5>
              <p>Puzzle, strategy </p>
            </div>
          </div>
        </div>
      ...
      <div class="text-center wow fadeInUp">
        <a href="https://github.com/deku31" class="btn btn-theme">Load More</a>
      </div>
    </div>
  ...
  <!-- Footer -->
  <div class="vg-footer">
    <h1 class="text-center">Deri Kurniawan</h1>
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-lg-3 py-3">
          <div class="float-lg-right">
            ...
            <ul class="list-unstyled">
              <li>derikurniawan8020190351@gmail.com</li>
              <li>+6282290337516</li>
            </ul>
          </div>
        </div>
